...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'heroes.sukuev.name': { ru: 'Виталий Сукуев', en: 'Vitaly Sukuev' },
  'heroes.sukuev.awards': { ru: 'Герой Российской Федерации (посмертно, 14 ноября 2022)', en: 'Hero of the Russian Federation (posthumously, November 14, 2022)' },
  'heroes.sukuev.desc': { ru: 'Гвардии полковник, командир 108-го гвардейского десантно-штурмового полка 7-й гвардейской горной дивизии ВДВ. Погиб 28 сентября 2022 года, приняв удар взрыва противотанковой мины. Посвятил 25 лет жизни службе в Вооружённых силах РФ.', en: 'Guards Colonel, commander of the 108th Guards Assault Regiment of the 7th Guards Mountain Division of the Airborne Forces. Died on September 28, 2022, taking the blast of an anti-tank mine. Devoted 25 years of his life to service in the Russian Armed Forces.' },
  'heroes.darchenko.name': { ru: 'Дмитрий Дарченко', en: 'Dmitry Darchenko' },
  'heroes.darchenko.awards': { ru: 'Герой Российской Федерации (посмертно, 11 марта 2024)', en: 'Hero of the Russian Federation (posthumously, March 11, 2024)' },
  'heroes.darchenko.desc': { ru: 'Гвардии прапорщик, командир штурмовой группы 76-й гвардейской десантно-штурмовой дивизии. 29 августа 2023 г. ворвался на позиции противника близ н.п. Работино, уничтожил 10 националистов. Прикрывая отход товарищей, погиб от артиллерийского удара.', en: 'Guards Warrant Officer, assault group commander of the 76th Guards Air Assault Division. On August 29, 2023 stormed enemy positions near Rabotino, eliminating 10 fighters. Covering the retreat of his comrades, he was killed by an artillery strike.' },
  'heroes.volkov.name': { ru: 'Александр Волков', en: 'Alexander Volkov' },
  'heroes.volkov.awards': { ru: 'Герой Российской Федерации (8 декабря 2022)', en: 'Hero of the Russian Federation (December 8, 2022)' },
  'heroes.volkov.desc': { ru: 'Майор, командир разведывательной группы. В ходе СВО вскрыл порядка 20 огневых позиций противника, захватил в плен командира роты ВСУ. Участник контртеррористических операций на Северном Кавказе и операции в Сирийской Арабской Республике.', en: 'Major, reconnaissance group commander. During the special military operation, he identified about 20 enemy firing positions and captured a Ukrainian company commander. Participant in counter-terrorist operations in the North Caucasus and operations in the Syrian Arab Republic.' },
  'heroes.voloskov.name': { ru: 'Андрей Волосков', en: 'Andrey Voloskov' },
  'heroes.voloskov.awards': { ru: 'Герой Российской Федерации (посмертно, 22 февраля 2024)', en: 'Hero of the Russian Federation (posthumously, February 22, 2024)' },
  'heroes.voloskov.desc': { ru: 'Гвардии лейтенант, командир парашютно-десантного взвода 299-го полка 98-й гвардейской дивизии. Двое суток удерживал рубеж в лесополосе «Зуб». Будучи тяжело ранен, отказался от эвакуации и продолжал руководить боем, прикрывая отход товарищей.', en: 'Guards Lieutenant, paratrooper platoon commander of the 299th Regiment, 98th Guards Division. Held the "Zub" forest line for two days. Despite being seriously wounded, refused evacuation and continued to lead the battle, covering the retreat of his comrades.' },
  'heroes.mikhailov.name': { ru: 'Максим Михайлов', en: 'Maxim Mikhailov' },
  'heroes.mikhailov.awards': { ru: 'Герой Российской Федерации (посмертно, 1 июня 2022)', en: 'Hero of the Russian Federation (posthumously, June 1, 2022)' },
  'heroes.mikhailov.desc': { ru: 'Гвардии старший лейтенант, командир танковой роты 42-й гвардейской дивизии. 3 марта 2022 г. под Мелитополем экипаж его танка уничтожил 4 танка, 6 боевых машин и до 50 военнослужащих противника. Погиб 24 марта 2022 г. в результате поражения вражеским снарядом.', en: 'Guards Senior Lieutenant, tank company commander of the 42nd Guards Division. On March 3, 2022 near Melitopol, his tank crew destroyed 4 tanks, 6 armored vehicles and up to 50 enemy soldiers. Killed on March 24, 2022 after his tank was hit by an enemy shell.' },
  ...
  'palagin.portrait.caption': { ru: 'Фото', en: 'Photo' },
  'palagin.portrait.desc': { ru: 'С.В. Палагин в кабине вертолёта', en: 'S.V. Palagin in the helicopter cockpit' },
