...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'hall2.photo0.tag': { ru: 'Памятная доска', en: 'Memorial Plaque' },
  'hall2.photo0.title': { ru: 'Памятная доска с именами героев', en: 'Memorial plaque with names of heroes' },
  'hall2.photo0.desc': { ru: 'Алый стенд с золотыми именами земляков-героев, отдавших жизнь за Родину. Каждое имя — судьба, каждая звезда — память.', en: 'A crimson stand with golden names of hometown heroes who gave their lives for the Motherland. Every name is a fate, every star is a memory.' },
  ...
  'hall2.photo4.desc': { ru: 'Стенд о 46-м гвардейском Таманском ночном бомбардировочном авиационном полку — легендарных «ночных ведьмах», совершивших 23 872 боевых вылета.', en: 'Stand about the 46th Guards Taman Night Bomber Aviation Regiment — the legendary "Night Witches" who flew 23,872 combat sorties.' },
